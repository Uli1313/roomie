import"./bootstrap.min-340b141d.js";import{a as o}from"./axios-28bc18a3.js";const m="https://roomie-lfta.onrender.com";let d,n=1;const l=2,h=document.querySelector(".news-list"),g=document.querySelector(".pagination"),v=document.querySelector(".news-search");let r,s;v.addEventListener("submit",a=>{a.preventDefault();const t=document.querySelector(".news-search-input").value.trim();t===""?(f(),c(n,l)):o.get(`${m}/news?title_like=${t}`).then(e=>{const i=e.data;r=e.data.length,s=Math.ceil(r/l),p(s),u(i)}).catch(e=>{console.log(e)})});function f(){o.get(`${m}/news`).then(a=>{r=a.data.length,s=Math.ceil(r/l),p(s)}).catch(a=>{console.log(a)})}function p(a){let t="";t+=`<li class="page-item">
